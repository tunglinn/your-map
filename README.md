...
- Youbike stations (live, Taipei) — official city feed, fetched directly (CORS-enabled), refreshed on load. Marker is a 🚲 badge whose background color is the availability signal (green/amber/red).
